  ...
  return (
    <div className="instructions">
      ...
      <ol>
        ...
        <li><strong>Double-click</strong> a cell to add colors (first double-click = color 1, second = color 2)</li>
        <li><strong>Click and drag</strong> on a cell (with 2 colors) to blend them together</li>
        <li>After blending, double-click to add a new color and continue blending</li>
      </ol>

      <h4>✨ Aesthetic Palette Mode:</h4>
      <ol>
        <li>Upload an image and hover over it to preview colors</li>
        <li><strong>Double-click</strong> ONLY the 4 corner cells to set colors</li>
